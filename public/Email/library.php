...
define("SMTP_UNAME", "huynguyenz2002@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "jvhsqyuezrimqwek"); //Password for SMTP authentication
