                            ...
                            <li>
                                <form>
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <input class="btn btn-primary submit" id="success" role="button" name="submit" type="submit" data-user="<?php echo $_SESSION['user_account']['user_id'] ?>" data-id="<?php echo $id_sp ?>" value="Thêm vào giỏ hàng">
                                        </div>
                                    </div>
                                </form>
                            </li>
